...
LV_IMAGE_DECLARE(screen_xiaozhiui_bgpreview6_1);
...
LV_IMAGE_DECLARE(screen_xiaozhiui_bgpreview6_24);
LV_IMAGE_DECLARE(screen_xiaozhiui_bgpreview6_25);
LV_IMAGE_DECLARE(screen_xiaozhiui_bgpreview6_26);
LV_IMAGE_DECLARE(screen_xiaozhiui_bgpreview6_27);
LV_IMAGE_DECLARE(screen_xiaozhiui_bgpreview6_28);
LV_IMAGE_DECLARE(screen_xiaozhiui_bgpreview6_29);
...
LV_IMAGE_DECLARE(screen_xiaozhiui_bgpreview6_9);
