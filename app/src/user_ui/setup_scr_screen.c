...
void setup_scr_screen(lv_ui *ui)
{
    ...
    //Write codes screen_xiaozhi_bg
    ui->screen_xiaozhi_bg = lv_obj_create(ui->screen);
    lv_obj_set_pos(ui->screen_xiaozhi_bg, 0, 0);
    lv_obj_set_size(ui->screen_xiaozhi_bg, 390, 450);
    lv_obj_set_scrollbar_mode(ui->screen_xiaozhi_bg, LV_SCROLLBAR_MODE_OFF);

    //Write style for screen_xiaozhi_bg, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->screen_xiaozhi_bg, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(ui->screen_xiaozhi_bg, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui->screen_xiaozhi_bg, lv_color_hex(0x2195f6), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_side(ui->screen_xiaozhi_bg, LV_BORDER_SIDE_FULL, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_xiaozhi_bg, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->screen_xiaozhi_bg, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->screen_xiaozhi_bg, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->screen_xiaozhi_bg, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->screen_xiaozhi_bg, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->screen_xiaozhi_bg, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_xiaozhi_bg, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_xiaozhiui_time
    ui->screen_xiaozhiui_time = lv_label_create(ui->screen);
    lv_obj_set_pos(ui->screen_xiaozhiui_time, 70, 85);
    lv_obj_set_size(ui->screen_xiaozhiui_time, 230, 70);
    ...
    lv_obj_set_style_text_font(ui->screen_xiaozhiui_time, &lv_font_AlexBrush_Regular_80, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_xiaozhiui_weather, 94, 15);
    ...
    lv_obj_set_style_border_opa(ui->screen_xiaozhiui_weather, 139, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui->screen_xiaozhiui_weather, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_opa(ui->screen_xiaozhiui_weather, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->screen_xiaozhiui_weather, 8, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_xiaozhiui_connect, 250, 251);
    ...
    lv_obj_set_style_border_opa(ui->screen_xiaozhiui_connect, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_line_space(ui->screen_xiaozhiui_connect, 1, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->screen_xiaozhiui_connect, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->screen_xiaozhiui_connect, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->screen_xiaozhiui_connect, 8, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_xiaozhiui_second, 312, 110);
    ...
    //Write style for screen_xiaozhiui_second, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->screen_xiaozhiui_second, 1, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(ui->screen_xiaozhiui_second, 144, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui->screen_xiaozhiui_second, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_align(ui->screen_xiaozhiui_second, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->screen_xiaozhiui_second, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_shadow_width(ui->screen_xiaozhiui_second, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_xiaozhiui_ble_N
    ui->screen_xiaozhiui_ble_N = lv_image_create(ui->screen);
    lv_obj_set_pos(ui->screen_xiaozhiui_ble_N, 50, 15);
    lv_obj_set_size(ui->screen_xiaozhiui_ble_N, 40, 40);
    lv_obj_add_flag(ui->screen_xiaozhiui_ble_N, LV_OBJ_FLAG_CLICKABLE);
    lv_image_set_src(ui->screen_xiaozhiui_ble_N, &_bluetooth2_RGB565A8_40x40);
    ...
    lv_obj_set_pos(ui->screen_xiaozhiui_ble_Y, 50, 15);
    lv_obj_set_size(ui->screen_xiaozhiui_ble_Y, 40, 40);
    ...
    lv_image_set_src(ui->screen_xiaozhiui_ble_Y, &_bluetooth1_RGB565A8_40x40);
    ...
    lv_obj_set_pos(ui->screen_xiazhiui_battery, 300, 15);
    ...
    lv_obj_set_style_bg_color(ui->screen_xiazhiui_battery, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_xiaozhiui_date, 254, 161);
    ...
    lv_obj_set_pos(ui->screen_xiaozhiui_battery_percent, 312, 47);
